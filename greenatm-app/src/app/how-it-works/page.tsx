...
const STEPS: { n: number; actor: Actor; what: string; out: string; exc: string; built: boolean }[] = [
  ...
  { n: 6, actor: "agent", what: "อ่านหลักฐานเทียบเกณฑ์ → เสนอชั้น A–D และบอกว่ายังขาดอะไร",
    out: "ข้อเสนอ สถานะ pending", exc: "ตอบไม่เป็น JSON สองครั้ง → รายงานว่าไม่สำเร็จ ไม่เดาชั้นให้", built: true },
    ...
    <Shell active="home">
      ...
      <div className="ga-banner-warn">
        ...
        <div style={{ fontWeight: 400, fontSize: 12.5, lineHeight: 1.9 }}>
          · <b>ขั้นที่ 6 (Agent) รันกับ endpoint จริงแล้ว</b> — อ่านชั้นข้อความใน PDF
          แล้วเสนอชั้น A–D พร้อมเหตุผล บันทึกทุกครั้งลงตาราง <code>agent_run</code>
          <br />
          · <b>แต่ยังไม่ทำ OCR</b> — ไฟล์สแกนกับรูปภาพอ่านเนื้อไม่ได้ ระบบจะเขียนบนหน้าจอว่า
          อ่านไม่ได้ และ agent ตัดสินจากชื่อกับวันที่เท่านั้น · ไฟล์ Word ยังไม่รองรับ
          <br />
          · <b>เอกสารยาวถูกตัดที่ 6,000 ตัวอักษร</b> — หน้าจอบอกว่าส่งไปกี่ตัวจากทั้งหมดเท่าไร
          <br />
          · <b>ระบบยังไม่มีข้อความเกณฑ์รายข้อ</b> — agent จึงตัดสินจากลักษณะของเอกสาร
          ไม่ได้เทียบกับเกณฑ์ที่เขียนไว้เป็นทางการ
          <br />
